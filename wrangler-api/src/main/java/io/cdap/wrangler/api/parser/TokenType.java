...
public enum TokenType implements Serializable {
  ...
  IDENTIFIER,
  /**
     * Represents the enumerated type for the object {@code ByteSize} type.
     * This type is associated with tokens representing data sizes (e.g., "10KB", "1.5MB").
     */
    BYTE_SIZE,

    /**
     * Represents the enumerated type for the object {@code TimeDuration} type.
     * This type is associated with tokens representing time durations (e.g.,"500ms","2m").
     */
    TIME_DURATION
}
